...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2025 a las 05:46:40
...
(1, 41607.00, '2025-05-20 20:40:14'),
...
(3, 23, '2025-05-14 23:55:43', 2570.00, 2570.00, 0.00);
...
(60, 39, 22, 1, 1212.00, 1212.00),
(61, 39, 10, 1, 21.00, 21.00),
(62, 40, 22, 1, 1212.00, 1212.00),
(63, 41, 8, 1, 25.00, 25.00),
(64, 42, 8, 4, 25.00, 100.00),
(65, 43, 22, 3, 1212.00, 3636.00),
(66, 44, 22, 4, 1212.00, 4848.00),
(67, 45, 22, 4, 1212.00, 4848.00),
(68, 46, 25, 5, 22.00, 110.00),
(69, 47, 23, 2, 121.00, 242.00),
(70, 48, 22, 1, 1212.00, 1212.00),
(71, 49, 22, 1, 1212.00, 1212.00),
(72, 50, 22, 3, 1212.00, 3636.00),
(73, 51, 22, 2, 1212.00, 2424.00);
...
(8, 'Roles de canela', 'Roles', 25.00, 15.00, 'Pan', 36, 0, NULL, NULL, 8),
(9, 'Sabritas', 'Sabritas de sal', 21.00, 10.00, 'Sabritas', 18, 1, NULL, NULL, 8),
(10, 'Galletas', ':v', 21.00, 15.00, 'galletas', 37, 2, NULL, NULL, 10),
...
(22, 'papa', ':v', 1212.00, 1.00, 'Sabritas', 1192, 1, NULL, NULL, 13),
(23, 'Sabritas', '12122121', 121.00, 121.00, 'Sabritas', 6, 1, NULL, NULL, 18),
(24, 'Evelynncita', 'Rica', 150.00, 100.00, 'si', 1, 0, NULL, NULL, 20),
(25, 'Coca', 'Coca', 22.00, 18.00, 'coca', 99992, 1, NULL, NULL, 21),
...
CREATE TABLE `venta` (
  ...
  `Fecha` datetime NOT NULL DEFAULT current_timestamp(),
  `Total` decimal(10,2) NOT NULL,
  `tipo_pago` char(1) NOT NULL COMMENT 'E = Efectivo, T = Tarjeta, M = Mixto',
...
INSERT INTO `venta` (`Folio`, `Id_Empleado`, `Fecha`, `Total`, `tipo_pago`, `Cambio`, `num_tarjeta`) VALUES
(39, 23, '2025-05-14 23:31:32', 1233.00, 'e', 0.00, NULL),
(40, 23, '2025-05-14 23:38:04', 1212.00, 'e', 0.00, NULL),
(41, 23, '2025-05-14 23:44:28', 25.00, 'e', 0.00, NULL),
(42, 24, '2025-05-14 23:50:54', 100.00, 'e', 1.00, NULL),
(43, 23, '2025-05-20 19:52:34', 3636.00, '0', 0.00, '1234567891234522'),
(44, 23, '2025-05-20 19:53:20', 4848.00, '0', 152.00, ''),
(45, 23, '2025-05-20 19:59:11', 4848.00, '0', 152.00, ''),
(46, 23, '2025-05-20 20:10:17', 110.00, 'e', 10.00, '0'),
(47, 23, '2025-05-20 20:11:06', 242.00, 't', 0.00, '1.23456789123e15'),
(48, 23, '2025-05-20 20:27:23', 1212.00, 'e', 0.00, '0'),
(49, 23, '2025-05-20 20:28:29', 1212.00, 't', 0.00, '1.234567891123456e15'),
(50, 23, '2025-05-20 20:29:28', 3636.00, 't', 0.00, ''),
(51, 23, '2025-05-20 20:40:14', 2424.00, 't', 0.00, '1234567891123456');
...
--
ALTER TABLE `venta`
  MODIFY `Folio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
